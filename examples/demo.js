...
async function runDemo() {
  ...
  try {
    ...
    const visionModels = allModels.filter(
      model => model.capabilities && model.capabilities.includes('vision')
    );
    const toolModels = allModels.filter(
      model => model.capabilities && model.capabilities.includes('tools')
    );
    const embeddingModels = allModels.filter(
      model => model.capabilities && model.capabilities.includes('embedding')
    );
